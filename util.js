...
export const formatDateLabels = (function () {
    ...
    */
    ...
    return function (locale, format, date) {
        ...
        const components = format.match(componentsRegex).slice(1);
        ...
        const labels = [components[0], components[2]].map(component => {
            ...
            return {label: label, type: component.indexOf('yy') !== -1 ? 'year' : 'month'};
        });
        return {
            separator: separator,
            labels: labels
...
export const TYPE_VALUE_RESOLVER_MAP = {
    ...
    date: {formatter: DATE_FORMATTER, parser: DATE_PARSER},
    week: {formatter: DATE_FORMATTER, parser: DATE_PARSER},
    datetime: {formatter: DATE_FORMATTER, parser: DATE_PARSER},
    daterange: {formatter: RANGE_FORMATTER, parser: RANGE_PARSER},
    datetimerange: {formatter: RANGE_FORMATTER, parser: RANGE_PARSER},
    timerange: {formatter: RANGE_FORMATTER, parser: RANGE_PARSER},
    time: {formatter: DATE_FORMATTER, parser: DATE_PARSER},
    month: {formatter: DATE_FORMATTER, parser: DATE_PARSER},
    quarter: {formatter: DATE_FORMATTER, parser: DATE_PARSER},
    year: {formatter: DATE_FORMATTER, parser: DATE_PARSER},
    multiple: {
